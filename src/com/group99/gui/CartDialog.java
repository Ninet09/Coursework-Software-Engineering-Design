										...
										askDialogPanel.setPaymentDialogPanelListener(new PaymentDialogPanelListener() {
											...
											public void onConfirmClicked(String accountNum, String accountPassword,
												...
												try {
													...
													List<Ticket> myTickets = TicketDomParser.getTickets();
													FileWriter fileWriter = new FileWriter("./allTickets.txt");
													BufferedWriter bufferedWriter = new BufferedWriter(fileWriter);
													for(Ticket myTicket : myTickets){
														bufferedWriter.write(myTicket.getTicketId());
														bufferedWriter.newLine();
														bufferedWriter.write(myTicket.getTiketType());
														bufferedWriter.newLine();
														bufferedWriter.write(myTicket.getScreenName());
														bufferedWriter.newLine();
														bufferedWriter.write(myTicket.getFilmName());
														bufferedWriter.newLine();
													}
